...
public class ExcelUtility {
    ...
    //BURADA TEST SONUÇLARINI BİR EXCEL DOSYASINA YAZDIRDIK
    public static void writeExcel(String path, Scenario scenario, String browserName, String time) {

        File f = new File(path);


        if (!f.exists()) {//file türünden bir dosya yoksa anlamı var
            ...
            newCell.setCellValue(scenario.getName());//bilgi yazıldı
