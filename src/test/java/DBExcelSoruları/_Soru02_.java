...
public class _Soru02_ extends JDBCParent {

                   //BU METHOD DB DEN VERİYİ OKUYUP EXCELE YAZDIRMAA İÇİN KULLANILIYOR AMA ÇALIŞTIRMA KAYNAK EXCEL  DOSSYASI YOK
    ...
    public void writeExcel(int b, int a, ArrayList<String> rsList, ArrayList<String> rsmdList) {
        ...
        try {
            FileOutputStream fileOutputStream = new FileOutputStream("src/test/java/ApachePOI/resource/jdbc3.xlsx");
